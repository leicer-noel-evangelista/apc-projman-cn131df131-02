...
<div class="common-body">
	<div class="col-md-12">
		...
		<div class="pull-left">
			<h4>Add Delivery Equipment <small>#<?php echo Helper::formatID($id); ?></small></h4>
			<p>Add supply item to the delivery record</p>
		</div>
		
		<div class="pull-right">
			<br/>
			<a class="btn btn-danger" href="deliveries_equipment.php?delivery_id=<?php echo $id; ?>"><i class="glyphicon glyphicon-arrow-left"></i> Go Back</a>
			<br/>
		...
		<form action="php/action.php" method="post">
			<input type="hidden" name="action" value="delivery_equipment_add"/>
			<input type="hidden" name="delivery_id" value="<?php echo $info['delivery_id']; ?>"/>
			<div class="col-md-12">
				<div class="form-group">
				...
				<button type="submit" class="btn btn-primary pull-right"><i class="glyphicon glyphicon-plus"></i> Add Delivery Equipment</button>
			</div>
		</form>
